...
namespace App\Livewire\Pages\Admin\MarketplaceResources\Components;
    ...
    return PowerGrid::fields()
      ->add('action', fn($record) => Blade::render('
        <x-dropdown no-x-anchor class="btn-sm">
            <x-menu-item title="Show" Link="/marketplace/show/' . e($record->id) . '/readonly" />
            <x-menu-item title="Edit" Link="/marketplace/edit/' . e($record->id) . '"/>
        </x-dropdown>'))
      ->add('id')
      ->add('name')
