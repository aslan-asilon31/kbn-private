        ...
        <div class="mt-12 flex flex-col items-center">
          ...
          <div class="w-full flex-1 mt-8">
            ...
            <div class="mx-auto max-w-xs">
              ...
              <button
                class="mt-5 tracking-wide font-semibold bg-[#96694C] text-gray-100 w-full py-2 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
