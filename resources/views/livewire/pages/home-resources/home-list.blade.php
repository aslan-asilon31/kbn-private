  ...
  <section class="blog blog-block blog-intro">
      ...
      <div class="container">
          ...
          <div class="row row-clean">
            ...
            @forelse($product_category_first as $product_category_first)
                    ...
                    <article>
                        <a href="products-grid.html">
                            ...
                            <div class="entry entry-block">
                                ...
                                <div class="title">
                                    <h2 class="h3">{{ $product_category_first->name }}</h2>
                                </div>
              ...
              <article>
                  <div>
                      <div class="image">
                          ...
                          <!--Desktop image-->
                          <img src="{{ asset('frontend/assets/images/shop-2.jpg') }}" alt="" class="hidden-xs" />
  
                          <!--Mobile image-->
                          <img src="{{ asset('frontend/assets/images/shop-2-mobile.jpg') }}" alt="" class="visible-xs" />
