<div>
        ...
        <section class="banner">
            <div class="container">
                <div class="row">
                    <div class="col-md-offset-2 col-md-8 text-center">
                        <h1 class="h2 title">Work with us</h1>
                        <div class="text">
                            <p>
                                We are constantly looking for talent with technical skills, a problem-solving approach and with a natural ability to take responsibility and act. We are a knowledge-intensive business which demands a high standard of professionalism and engaged employees.
                            </p>
                            <p><a href="#" class="btn btn-clean">Apply now</a></p>
                        </div>
                    </div>
                </div>
            </div>
